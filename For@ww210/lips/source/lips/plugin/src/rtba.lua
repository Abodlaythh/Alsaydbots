...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من المخانيثقبل شوي 🙃 ").Reply,"md",true)  
else
Redis:srem(Fast.."kholat:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من المخانيثلازم ياخد دروس رجوله😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "وتكه" then
if not Redis:sismember(Fast.."wtka:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الوتكات قبل شوي 🙃 ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• محطوط ف قايمة المخانيثمن  بدري 😂 ").Reply,"md",true)  
else
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المخابيل', data = senderr..'/Delkholat'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• ماكو متوحدين هنا كلهم اتعالجو 😂😂 , ","md",true)  
end
ListMembers = '\n*• قائمه المتوحدين  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• ماكو كلاب هنا ارفعلنل شويه نضيهم عضم 😂😂 , ","md",true)  
end
ListMembers = '\n*• قائمه الكلاب  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• ماكو عرر هنا 😂😂 , ","md",true)  
end
ListMembers = '\n*• قائمه العرر  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• ماكو سمباويه هنا 😂😂 , ","md",true)  
end
ListMembers = '\n*• قائمه السمب  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• ماكو قرود هنا يصحبي 😂😂 , ","md",true)  
end
ListMembers = '\n*• قائمه القرود  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• ماكو اغبيه هنا يصحبي 😂😂 , ","md",true)  
end
ListMembers = '\n*• قائمه الاغبيه  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
