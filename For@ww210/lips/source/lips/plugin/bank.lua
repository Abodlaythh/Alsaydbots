...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ السيد ماعندها حساب بالبنك 🤣","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"\n*← السيد معندهوش حساب بالبنك 🤣*","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "⌯ حوالة صادرة من بنك السيد\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المستلم : "..newss.."\n⇜ الحساب رقم : `"..text.."`\n⇜ نوع البطاقة : "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ : "..convert_mony.." دينار 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك السيد\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المبلغ : "..convert_mony.." دينار 💵","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
else
...
bot.sendText(msg.chat_id,msg.id,"← هذه رشوة بطل زرف "..jjjo.." دينار 💵","md",true)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تزرفه فلوسه اقل من 200 دينار 💵","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 1000000000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 200000000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 30000000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 1000000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 300000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 120000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 80000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 30000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تطور راتبك تحتاج مبلغ 3000 دينار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مينفعش تهجم فلوسك اقل من 100000 دينار 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return send(msg.chat_id,msg.id, "⇜ مينفعش تهجم عليه فلوسه اقل من 100000 دينار 💵","md",true)
end
...
if (text == 'طرد عامل' or text == 'رفض') and msg.reply_to_message_id == 0 then
ballanceed = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
send(msg.chat_id,msg.id, "⇜ استعمل الامر كذا :\n\n⇜ `طرد` بالرد","md",true)
end
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@boo000o")
sleep(1)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح هو 1k دينار 💵\n⧫","md",true)
end
if tonumber(coniss) < 999 then
return bot.sendText(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 دينار 💵\n⧫","md",true)
end
...
Redis:setex(Fast.."aglahd" .. msg.sender_id.user_id,1800, true)
    local msg_text = ""
    local photo = "hhttps://t.me/ii00v/17"
...
local convert_mony = string.format("%.0f",ballancee)
bot.sendText(msg.chat_id,msg.id, "← تبرعاتك : `"..convert_mony.."` دينار 💵","md",true)
else
bot.sendText(msg.chat_id,msg.id, "← معندكش حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
