...
chsource = Redis:get(Fast..'chsource') or "boo000o"
devsource = Redis:get(Fast..'devsource') or "ww210"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,909933097,909933097,909933097,909933097,909933097,909933097,909933097}
...
if UserId == 909933097 then
Status = true
elseif UserId == 909933097 then
Status = true
elseif UserId == 909933097 then
Status = true
elseif UserId == 909933097 then
...
local GetMemberStatus = bot.getChatMember(ChatId,user2).status.rights 
...
elseif tonumber(Message) < 9099330971 then 
...
if tonumber(senderr) == 909933097 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 909933097 then
...
if msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج نورت الكروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(909933097) then
...
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزي المطور رتبتك هنآ صآحب الليله دي - ✅","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(909933097) then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "السيد")
...
num = {"اما قله ادب صحيح كله كذب فى كذب💔😔"," هذا مضبوط🙂😹"," اقلك الكلام هذا كذب واللى قالولك كذابين وانت كذاب واللى يتفرج هم كذاب??😂"," هذا رجال وموثق كمان❤️😁","فعلا بتتكلم صح🤗","يمعود كول كلام غير هذه😹","احس هل شي كذب🌚💕","شو حط عيني ب عينك  ??","انت صح",};
sendnum = num[math.random(#num)]
sl = ' ⟨  '..text..'  ⟩ \n '..sendnum..' '
...
if text == 'رفع نسخه السيد' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return send(msg_chat_id,msg_id,'• تم استرجاع المجموعات من نسخه السيد')
else
...
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Snap..'Num:Add:Bot') or 0)) and not msg.Asasy then
return send(msg_chat_id,msg_id,'☆︙عدد الاعضاء قليل لا يمكن تفعيل الكروب  يجب ان يكون اكثر من :'..Redis:get(Snap..'Num:Add:Bot'),"md",true)  
end
if Redis:sismember(Snap.."ChekBotAdd",msg_chat_id) then
...
Redis:sadd(Snap.."Ownerss:Group"..msg_chat_id,v.member_id.user_id) 
else
Redis:sadd(Snap.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:set(Snap..'tagallgroup'..msg.chat_id,'open') 
Redis:set(Snap.."Status:Link"..msg_chat_id,true) 
Redis:set(Snap.."Status:Games"..msg_chat_id,true) 
Redis:set(Snap.."AlThther:Chat"..msg.chat_id,"true")
Redis:set(Snap.."replayallbot"..msg.chat_id,true)
Redis:set(Snap.."Status:Welcome"..msg_chat_id,true) 
Redis:set(Snap.."AlThther:Chat"..msg.chat_id,"true")
Redis:set(Snap..'tagall@all'..msg.chat_id,'open') 
Redis:set(Snap.."Status:IdPhoto"..msg_chat_id,true) 
Redis:del(Snap.."spammkick"..msg.chat_id)
Redis:set(Snap.."Lock:edit"..msg_chat_id,true) 
Redis:sadd(Snap.."ChekBotAdd",msg_chat_id)
Redis:set(Snap.."Status:Id"..msg_chat_id,true) ;Redis:set(Snap.."Status:Reply"..msg_chat_id,true) ;Redis:set(Snap.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Snap.."Status:BanId"..msg_chat_id,true) ;Redis:set(Snap.."Status:SetId"..msg_chat_id,true) 
...
if Redis:sismember(Snap..'Black:listBan:',msg_chat_id) then
...
if not Redis:get(Snap.."BotFree") then
...
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Snap.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Snap.."ChekBotAdd",msg_chat_id)
return send(msg_chat_id,msg_id,'\n*☆︙الكروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n☆︙ تم تعطيلها بنجاح *','md',true)
end
end

if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Snap.."ChekBotAdd",msg_chat_id) then
Redis:incr(Snap..'Num:Message:User'..msg.chat_id..':'..msg.sender_id.user_id) 

if text then
local GetMsg = Redis:incr(Snap..'Num:Message:User'..msg.chat_id..':'..msg.sender_id.user_id) 
Redis:hset(Snap..':GroupUserCountMsg:'..msg.chat_id,msg.sender_id.user_id,GetMsg)
local UserInfo = bot.getUser(msg.sender_id.user_id) 
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Snap..':GroupNameUser:'..msg.chat_id,msg.sender_id.user_id,NameLUser)
end
...
if text == 'مسح المكالسيدين عام' then
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id," •لا يوجد مكالسيدين عام حاليا , ","md",true)  
end
Redis:del(Fast.."KtmAll:Groups") 
return send(msg_chat_id,msg_id,"* •تم مسح {"..#Info_Members.."} من المكالسيدين عام *","md",true)
end

if text == 'المكالسيدين عام' or text == 'قائمه المكالسيدين عام' then
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المكالسيدين عام', data = senderr..'/KtmAll'},},}}
...
local name_amr = bot.getUser(909933097).first_name.." "..bot.getUser(909933097).last_name
local name_parlo = bot.getUser(909933097).first_name.." "..bot.getUser(909933097).last_name
local caption = "اليك قائمه مطورين سورس السيد :"
if tonumber(UserId_Info.id) ~= 909933097 then
...
data = {
{
{text = name_amr, data = msg.sender_id.user_id..'/DevShow@909933097'},
},
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@909933097'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/boo000o ", 'md', true)
end
...
local GetMemberStatus = bot.getChatMember(msg_chat_id,senderr).status.rights 
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if StatusMember == "chatMemberStatusAdministrator" then 
local GetMemberStatus = bot.getChatMember(msg_chat_id,rep_idd).status.rights
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
local GetMemberStatus = bot.getChatMember(msg_chat_id,Fast).status.rights 
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(909933097) then
...
if text == 'السيد' or text == 'المبرمج السيد' then
photo = "https://t.me/ww210"
local T =[[
[ٓ  ᯓ 𓆩 ˹ َِᖴُِOَِᒪَِᒪُِOَᗯ َTَِᕼَِ𝖤 َՏُِOَِᑌَᖇِّᑕَِ𝖤 َᗪَِ𝖤َᐯَِ𝖤َِᒪُِOِᑭَِ𝖤َᖇ َِᕼَِ𝖤َᖇَِ𝖤 ˼ 𓆪 𓆃](t.me/ii222v)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ kᎥꪀᘜ Ⴆᥲ️᥉𝗁ᥲ️ › .', url = "https://t.me/ww210"}
},
{
{text = '‹ ٰ𖣂 • ᥴꫝ • 𖣂 ›', url = "https://t.me/ww210"}
},
}
...
photo = "https://t.me/ww210"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](t.me/ww210 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• ᎷᏒ </> ᏰᏗᏒᏝᎧᵛ͢ᵎᵖ •𒅒 ⇣ › .', url = "https://t.me/ww210"}
},
{
...
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• ᎷᏒ </> 𝙏َِ𝙊َِ𝙈ِ •𒅒 ⇣ › .', url = "https://t.me/ww210"}
},
{
{text = '‹ ٰ𖣂 • ᑕᕼ • 𖣂 ›', url = "https://t.me/CClCCBOT"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'سيد' or text == 'يا سيد' then
photo = "https://t.me/boo000o"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](t.me/boo000o )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• ᎷᏒ </> 𝙈َٰ𝘼ٍَ𝙉ُِ𝙊ُِ •𒅒 ⇣ › .', url = "https://t.me/boo000o"}
},
{
{text = '‹ ٰ𖣂 • ᑕᕼ • 𖣂 ›', url = "https://t.me/boo000o"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'سيد' or text == 'سيد' then
photo = "https://t.me/boo000o"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](https://t.me/boo000o )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• ᎷᏒ </> 𖠧 ๏͈͈͈͈͈͈͈ρꪮ𝘬ꫀꪑꪮꪀ𖤓̟̟̟̟̟̟̥̥̥̥̟͜͡️ •𒅒 ⇣ › .', url = "https://t.me/boo000o"}
},
{
{text = '‹ ٰ𖣂 • ᑕᕼ • 𖣂 ›', url = "https://t.me/boo000o"}
},
...
if text == 'المبرمج' or text == 'السيد' or text  == 'المبرمج السيد' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(909933097,0,'*\n◉  مرحباً عزيزي المبرمج السيد \nشخص ما يحتاج الي مساعده\n⎈•━⊶𐂡• 𝐀𝐋𝐒𝐀𝐘𝐃 •𐂡⊷━•⎈\n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'السيد' or text == 'السيد'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
if msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"❍ انت السيد مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"❍ انت  مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"❍ انت  مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"انت [ صآحبه الليله دي] يقلبي 🥺♥","md",true)
elseif msg.sender_id.user_id == tonumber(909933097) then
send(msg_chat_id,msg_id,"❍ انت الالسيد مطور السورس يقلبي🌚♥","md",true)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مكالسيدين حاليا , ","md",true)  
end
Redis:del(Fast.."SilentGroup:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*• تم مسح {"..#Info_Members.."} من المكالسيدين *","md",true)
end
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(909933097) then
local txx = "\n"
...
{{text = '- ✦ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐒𝐀𝐘𝐃 ✦ •', url = "https://t.me/boo000o"}},
}
}
...
if text and (text == "ش" or text == "↫ شعر ✯") and not Redis:get(Fast..'sh3ir:Abs'..msg.chat_id) then
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/boo000o"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/boo000o"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@boo000o")
sleep(1)
...
data = {
{
{text = 'مطور السورس', url = "https://t.me/ww210"}
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐒𝐀𝐘𝐃', url = "https://t.me/boo000o"}
},
...
if text == (Redis:get(Fast.."Name:Bot") or "السيد") then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "السيد")
local NameBots = {
"قلب "..NamesBot.. "",
...
if Redis:get(Fast.."name bot type : ") == "photo" then
    ...
    if photo.total_count > 0 then
      ...
      "اسمي "..NamesBot.." ياحلو",
      "شتريد دوختني يمعود",
      "ترا بنعال على وجهك كافي تصيح",
      "اسمي "..NamesBot.." يا ياقلبي",
      "مانك شايف اسمي ولا متل العاجوز ماتشوف؟"
      }
...
{
{text="المكالسيدين عام",data=senderr..'/KtmAll'},{text="المحظورين عام",data=senderr..'/BanAll'},
},
{
...
{
{text="المكالسيدين",data=senderr..'/SilentGroupGroup'},{text="المحظورين",data=senderr..'/BanGroup'},
},
{
...
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكالسيدين')
...
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك للكل')
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..''تك','تنزيل جميع لرتب')      
...
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','مسح رد')
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
local listA = {'تعطيل الايدي بالصوره','تفعيل الايدي بالصوره','ايدي','رفع مميز', 'رفع ادمن','رفع مدير', 'رفع منشئ', 'رفع منشئ اساسي','رفع مطور','تنزيل الكل','الرابط','الردود','مسح المكالسيدين','اضف رد','غنيلي','رسائلي','رفع مطور ثانوي','مسح تعديلاتي','نقاطي','اسالني','لغز','معاني','حزوره','رفع القيود','الغاء حظر','تثبيت','كشف','تاك','تاك للكل','تغيير الايدي','تنزيل جميع الرتب','قفل الاشعارات','فتح الاشعارات','مسح رد','اضف امر'}
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكالسيدين')
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك للكل')
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل جميع لرتب')      
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','مسح رد')
...
if text == 'السيد' or text == 'مبرمج السورس' or text == 'Barlo' then  
local UserId_Info = bot.searchPublicChat("ww210")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '◈ ℻ᗪEᐯ • ᗷᗩᖇᒪO℻ ◈', url = "https://t.me/ww210"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج السيد ❳', url = "https://t.me/ww210"}
},
{
{text = '✦ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐒𝐀𝐘𝐃 ✦', url = "https://t.me/boo000o"},
},
...
data = {
{
{text = '𓆩 ˹ [𝙲𝙷] ˼ 𓆪', url = "https://t.me/boo000o"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 [𝙲𝙷] 𝙲𝚁𝙸𝚂𝚃𝙸𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 ❭• °](t.me/boo000o )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "السيد")..
